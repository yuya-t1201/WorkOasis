...
Rails.application.config.sorcery.configure do |config|
  ...
  #
  # config.linkedin.key = Rails.application.credentials.dig(:google, :client_id)
  # config.linkedin.secret = Rails.application.credentials.dig(:google, :client_secret)
  # config.linkedin.callback_url = Settings.sorcery[:google_callback_url]
